...
fill( [0,high_res_slice_vals, 10], [-y_corner-0.2; lower_wall; -y_corner-0.2],[0.5 0.5 0.5]);
fill( [0,high_res_slice_vals, 10], [ y_corner+0.2; upper_wall;  y_corner+0.2],[0.5 0.5 0.5]);

% Print name of file being analysed on the plot
text(3,y_corner + 0.1,file_string, 'Interpreter', 'none')
...
title(sprintf('Streamwise Pressure, %s',file_string),'interpreter','none')
xlabel('x')
ylabel('pressure')
set(gca,'XAxisLocation','origin')


saveas(visualiser_fig, ['..\MATLAB plots\',file_string,' flow visualised.png']);
saveas(pressure_fig,   ['..\MATLAB plots\',file_string,' streamwise pressure.png']);
